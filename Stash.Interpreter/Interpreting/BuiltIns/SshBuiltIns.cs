...
public static class SshBuiltIns
{
    ...
    {
        var ssh = new StashNamespace("ssh");
        ...
        ssh.Define("connect", new BuiltInFunction("ssh.connect", 1, (_, args) =>
        {
        ...
        ssh.Define("exec", new BuiltInFunction("ssh.exec", 2, (_, args) =>
        {
        ...
        ssh.Define("execAll", new BuiltInFunction("ssh.execAll", 2, (_, args) =>
        {
        ...
        ssh.Define("shell", new BuiltInFunction("ssh.shell", 2, (_, args) =>
        {
        ...
        ssh.Define("close", new BuiltInFunction("ssh.close", 1, (_, args) =>
        {
        ...
        ssh.Define("isConnected", new BuiltInFunction("ssh.isConnected", 1, (_, args) =>
        {
        ...
        ssh.Define("tunnel", new BuiltInFunction("ssh.tunnel", 2, (_, args) =>
        {
        ...
        ssh.Define("closeTunnel", new BuiltInFunction("ssh.closeTunnel", 1, (_, args) =>
        {
