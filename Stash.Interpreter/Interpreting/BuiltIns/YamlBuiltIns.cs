...
public static class YamlBuiltIns
{
    ...
    public static void Register(Stash.Interpreting.Environment globals)
    {
        ...
        yaml.Define("stringify", new BuiltInFunction("yaml.stringify", 1, (_, args) =>
        {
            try
            {
        ...
        yaml.Define("valid", new BuiltInFunction("yaml.valid", 1, (_, args) =>
        {
            if (args[0] is not string s)
            {
