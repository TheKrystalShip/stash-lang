...
/// <param name="Properties">The names of typed properties exposed to Stash code (may be empty).</param>
public sealed record BuiltInErrorMetadata(string Name, Type ClrType, IReadOnlyList<string> Properties);
