...
public class Parser
{
    ...
    {
        if (Match(TokenType.IntegerLiteral, TokenType.FloatLiteral, TokenType.StringLiteral, TokenType.IpAddressLiteral, TokenType.DurationLiteral, TokenType.ByteSizeLiteral))
        {
