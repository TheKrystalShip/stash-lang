...
public static class BuiltInRegistry
{
    ...
    public static readonly IReadOnlyList<NamespaceFunction> NamespaceFunctions = new[]
    {
        ...
        new NamespaceFunction("io", "confirm", new[] { new BuiltInParam("prompt", "string") }, "bool",
            Documentation: "Displays a confirmation prompt with [y/N] and reads user input. Returns true if the user types 'y' or 'yes' (case-insensitive).\n@param prompt The prompt message to display\n@return true if the user confirmed, false otherwise"),
        // conv namespace
        ...
        new NamespaceFunction("path", "name", new[] { new BuiltInParam("path", "string") }, "string",
            Documentation: "Returns the filename without extension from a path.\n@param path The file path\n@return The filename without extension (e.g., \"file\")"),        new NamespaceFunction("path", "normalize", new[] { new BuiltInParam("p", "string") }, "string",
            Documentation: "Normalizes a path by resolving . and .. segments and removing redundant separators.\n@param p The path to normalize\n@return The normalized path"),
        new NamespaceFunction("path", "isAbsolute", new[] { new BuiltInParam("p", "string") }, "bool",
            Documentation: "Checks whether a path is absolute.\n@param p The path to check\n@return true if the path is absolute"),
        new NamespaceFunction("path", "relative", new[] { new BuiltInParam("from", "string"), new BuiltInParam("to", "string") }, "string",
            Documentation: "Computes the relative path from one path to another.\n@param from The base path\n@param to The target path\n@return The relative path from 'from' to 'to'"),
        new NamespaceFunction("path", "separator", Array.Empty<BuiltInParam>(), "string",
            Documentation: "Returns the platform-specific path separator character (/ on Unix, \\ on Windows).\n@return The path separator as a string"),        // arr namespace
        ...
        new NamespaceFunction("arr", "zip", new[] { new BuiltInParam("a", "array"), new BuiltInParam("b", "array") }, "array",
            Documentation: "Combines two arrays into an array of two-element arrays, pairing elements at the same index. Stops at the shorter array's length.\n@param a The first array\n@param b The second array\n@return An array of [a[i], b[i]] pairs"),
        new NamespaceFunction("arr", "chunk", new[] { new BuiltInParam("array", "array"), new BuiltInParam("size", "int") }, "array",
            Documentation: "Splits an array into chunks of the specified size. The last chunk may be smaller.\n@param array The array to chunk\n@param size The size of each chunk (must be > 0)\n@return An array of arrays"),
        new NamespaceFunction("arr", "shuffle", new[] { new BuiltInParam("array", "array") },
            Documentation: "Randomly shuffles the elements of an array in-place using the Fisher-Yates algorithm.\n@param array The array to shuffle"),
        new NamespaceFunction("arr", "take", new[] { new BuiltInParam("array", "array"), new BuiltInParam("n", "int") }, "array",
            Documentation: "Returns a new array with the first n elements. If n exceeds the array length, returns a copy of the entire array.\n@param array The source array\n@param n The number of elements to take\n@return A new array with at most n elements"),
        new NamespaceFunction("arr", "drop", new[] { new BuiltInParam("array", "array"), new BuiltInParam("n", "int") }, "array",
            Documentation: "Returns a new array with the first n elements removed. If n exceeds the array length, returns an empty array.\n@param array The source array\n@param n The number of elements to skip\n@return A new array without the first n elements"),
        new NamespaceFunction("arr", "partition", new[] { new BuiltInParam("array", "array"), new BuiltInParam("fn", "function") }, "array",
            Documentation: "Splits an array into two arrays: the first containing elements for which the predicate returns truthy, the second containing the rest.\n@param array The source array\n@param fn A predicate function that takes an element\n@return An array of two arrays: [matching, non-matching]"),
        // dict namespace
        ...
        new NamespaceFunction("dict", "fromPairs", new[] { new BuiltInParam("pairs", "array") }, "dict",
            Documentation: "Creates a dictionary from an array of [key, value] pairs.\n@param pairs An array of two-element arrays\n@return A new dictionary"),
        new NamespaceFunction("dict", "pick", new[] { new BuiltInParam("dict", "dict"), new BuiltInParam("keys", "array") }, "dict",
            Documentation: "Returns a new dictionary containing only the specified keys from the source dictionary.\n@param dict The source dictionary\n@param keys An array of keys to include\n@return A new dictionary with only the picked keys"),
        new NamespaceFunction("dict", "omit", new[] { new BuiltInParam("dict", "dict"), new BuiltInParam("keys", "array") }, "dict",
            Documentation: "Returns a new dictionary with the specified keys excluded.\n@param dict The source dictionary\n@param keys An array of keys to exclude\n@return A new dictionary without the omitted keys"),
        new NamespaceFunction("dict", "defaults", new[] { new BuiltInParam("dict", "dict"), new BuiltInParam("defaults", "dict") }, "dict",
            Documentation: "Returns a new dictionary that fills in missing keys from a defaults dictionary. Existing keys in the source are not overwritten.\n@param dict The source dictionary\n@param defaults A dictionary of default values\n@return A new dictionary with defaults filled in"),
        new NamespaceFunction("dict", "any", new[] { new BuiltInParam("dict", "dict"), new BuiltInParam("fn", "function") }, "bool",
            Documentation: "Returns true if at least one entry satisfies the predicate function, which receives (key, value).\n@param dict The dictionary to test\n@param fn A predicate function taking (key, value)\n@return true if any entry passes the test"),
        new NamespaceFunction("dict", "every", new[] { new BuiltInParam("dict", "dict"), new BuiltInParam("fn", "function") }, "bool",
            Documentation: "Returns true if all entries satisfy the predicate function, which receives (key, value).\n@param dict The dictionary to test\n@param fn A predicate function taking (key, value)\n@return true if every entry passes the test"),
        new NamespaceFunction("dict", "find", new[] { new BuiltInParam("dict", "dict"), new BuiltInParam("fn", "function") },
            Documentation: "Returns the first value for which the predicate function returns truthy, or null if none match. The function receives (key, value).\n@param dict The dictionary to search\n@param fn A predicate function taking (key, value)\n@return The first matching value, or null"),
        // str namespace
        ...
        new NamespaceFunction("str", "capitalize", new[] { new BuiltInParam("s", "string") }, "string",
            Documentation: "Capitalizes the first character of a string and lowercases the rest.\n@param s The input string\n@return A new string with the first character capitalized"),
        new NamespaceFunction("str", "title", new[] { new BuiltInParam("s", "string") }, "string",
            Documentation: "Converts a string to title case — capitalizes the first letter of each word.\n@param s The input string\n@return A new string in title case"),
        new NamespaceFunction("str", "lines", new[] { new BuiltInParam("s", "string") }, "array",
            Documentation: "Splits a string into an array of lines, handling \\r\\n, \\r, and \\n line endings.\n@param s The input string\n@return An array of line strings"),
        new NamespaceFunction("str", "words", new[] { new BuiltInParam("s", "string") }, "array",
            Documentation: "Splits a string into an array of whitespace-separated words, removing empty entries.\n@param s The input string\n@return An array of word strings"),
        new NamespaceFunction("str", "truncate", new[] { new BuiltInParam("s", "string"), new BuiltInParam("maxLen", "int"), new BuiltInParam("suffix", "string") }, "string", IsVariadic: true,
            Documentation: "Truncates a string to maxLen characters, appending a suffix if truncated. Default suffix is \"...\".\n@param s The input string\n@param maxLen The maximum length\n@param suffix Optional suffix to append when truncated (default: \"...\")\n@return The truncated string"),
        new NamespaceFunction("str", "slug", new[] { new BuiltInParam("s", "string") }, "string",
            Documentation: "Converts a string to a URL-friendly slug: lowercases, replaces non-alphanumeric characters with hyphens, and trims leading/trailing hyphens.\n@param s The input string\n@return A slugified string"),
        new NamespaceFunction("str", "wrap", new[] { new BuiltInParam("s", "string"), new BuiltInParam("width", "int") }, "string",
            Documentation: "Word-wraps a string to the specified width, preserving existing paragraph breaks.\n@param s The input string\n@param width The maximum line width\n@return The wrapped string"),
        // assert namespace
        ...
        new NamespaceFunction("time", "year", new[] { new BuiltInParam("timestamp", "number") }, "int", IsVariadic: true,
            Documentation: "Returns the year component of a Unix timestamp. If no timestamp is provided, uses the current time.\n@param timestamp Optional Unix timestamp (defaults to now)\n@return The year as an integer"),
        new NamespaceFunction("time", "month", new[] { new BuiltInParam("timestamp", "number") }, "int", IsVariadic: true,
            Documentation: "Returns the month component (1-12) of a Unix timestamp. If no timestamp is provided, uses the current time.\n@param timestamp Optional Unix timestamp (defaults to now)\n@return The month as an integer (1-12)"),
        new NamespaceFunction("time", "day", new[] { new BuiltInParam("timestamp", "number") }, "int", IsVariadic: true,
            Documentation: "Returns the day-of-month component (1-31) of a Unix timestamp. If no timestamp is provided, uses the current time.\n@param timestamp Optional Unix timestamp (defaults to now)\n@return The day as an integer (1-31)"),
        new NamespaceFunction("time", "hour", new[] { new BuiltInParam("timestamp", "number") }, "int", IsVariadic: true,
            Documentation: "Returns the hour component (0-23) of a Unix timestamp. If no timestamp is provided, uses the current time.\n@param timestamp Optional Unix timestamp (defaults to now)\n@return The hour as an integer (0-23)"),
        new NamespaceFunction("time", "minute", new[] { new BuiltInParam("timestamp", "number") }, "int", IsVariadic: true,
            Documentation: "Returns the minute component (0-59) of a Unix timestamp. If no timestamp is provided, uses the current time.\n@param timestamp Optional Unix timestamp (defaults to now)\n@return The minute as an integer (0-59)"),
        new NamespaceFunction("time", "second", new[] { new BuiltInParam("timestamp", "number") }, "int", IsVariadic: true,
            Documentation: "Returns the second component (0-59) of a Unix timestamp. If no timestamp is provided, uses the current time.\n@param timestamp Optional Unix timestamp (defaults to now)\n@return The second as an integer (0-59)"),
        new NamespaceFunction("time", "dayOfWeek", new[] { new BuiltInParam("timestamp", "number") }, "string", IsVariadic: true,
            Documentation: "Returns the day of the week as a string (e.g., \"Monday\") for a Unix timestamp. If no timestamp is provided, uses the current time.\n@param timestamp Optional Unix timestamp (defaults to now)\n@return The day name as a string"),
        new NamespaceFunction("time", "add", new[] { new BuiltInParam("timestamp", "number"), new BuiltInParam("seconds", "number") }, "float",
            Documentation: "Adds a number of seconds to a Unix timestamp and returns the result.\n@param timestamp The base Unix timestamp\n@param seconds The number of seconds to add (can be negative)\n@return The new Unix timestamp as a float"),
        new NamespaceFunction("time", "diff", new[] { new BuiltInParam("ts1", "number"), new BuiltInParam("ts2", "number") }, "float",
            Documentation: "Returns the difference in seconds between two timestamps (ts1 - ts2).\n@param ts1 The first Unix timestamp\n@param ts2 The second Unix timestamp\n@return The difference in seconds as a float"),
        // json namespace
        ...
        new NamespaceFunction("json", "valid", new[] { new BuiltInParam("text", "string") }, "bool",
        ...
        // log namespace
        new NamespaceFunction("log", "debug", new[] { new BuiltInParam("message", "string") },
            Documentation: "Logs a debug-level message. Only output if the current log level is 'debug'.\n@param message The message to log"),
        new NamespaceFunction("log", "info", new[] { new BuiltInParam("message", "string") },
            Documentation: "Logs an info-level message. Output if the log level is 'debug' or 'info'.\n@param message The message to log"),
        new NamespaceFunction("log", "warn", new[] { new BuiltInParam("message", "string") },
            Documentation: "Logs a warning-level message. Output if the log level is 'debug', 'info', or 'warn'.\n@param message The message to log"),
        new NamespaceFunction("log", "error", new[] { new BuiltInParam("message", "string") },
            Documentation: "Logs an error-level message. Always output regardless of log level.\n@param message The message to log"),
        new NamespaceFunction("log", "setLevel", new[] { new BuiltInParam("level", "string") },
            Documentation: "Sets the minimum log level. Messages below this level are suppressed. Valid levels: 'debug', 'info', 'warn', 'error'.\n@param level The minimum log level"),
        new NamespaceFunction("log", "setFormat", new[] { new BuiltInParam("format", "string") },
