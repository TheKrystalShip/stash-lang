...
| 2026-05-24 | **Q9: Snippet priority pinned to `1000` (significantly below every other Default-mode provider).**               | Original design only required "strictly greater than `ScopedSymbolCompletionProvider.SourcePriority` (40)" so symbols win the dedup race. During P2 review (commit `0edffd6`) the user added a stronger policy: snippets must be deprioritized far below keywords (10) / stdlib fns (20) / stdlib namespaces (30) / scoped symbols (40) so they never get in the way of normal typing. `1000` is the deliberate "available but not pushy" value. The "strictly greater than 40" lower bound still holds; the actual value is just much higher. |
