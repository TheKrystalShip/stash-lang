...
public static class StdlibDefinitions
{
    ...
    [
        ...
        (() => TcpBuiltIns.Define(),       StashCapabilities.Network),
        (() => UdpBuiltIns.Define(),       StashCapabilities.Network),
        (() => WsBuiltIns.Define(),        StashCapabilities.Network),
        (() => DnsBuiltIns.Define(),       StashCapabilities.Network),
