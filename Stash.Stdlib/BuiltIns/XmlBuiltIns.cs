...
public static partial class XmlBuiltIns
{
    ...
    /// <exception cref="TypeError">if options is not an XmlParseOptions struct or a field has the wrong type</exception>
    /// <exception cref="ParseError">if the XML is malformed or the document has no root element</exception>
    ...
    /// <exception cref="TypeError">if node is not an XmlNode or options fields have the wrong type</exception>
    /// <exception cref="IOError">if serialization fails</exception>
    ...
    /// <exception cref="TypeError">if root is not an XmlNode</exception>
    /// <exception cref="ParseError">if the XPath expression is invalid</exception>
    /// <exception cref="IOError">if the query operation fails</exception>
