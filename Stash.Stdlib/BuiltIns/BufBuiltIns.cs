    ...
    public static NamespaceDefinition Define()
    {
        ...
        ns.Function("from", [Param("s", "string"), Param("encoding", "string")], static (IInterpreterContext _, ReadOnlySpan<StashValue> args) =>
        {
            ...
            System.Text.Encoding enc = encoding switch
            {
                ...
                _ => throw new RuntimeError($"buf.from: unsupported encoding '{encoding}'. Supported: utf-8, ascii, latin1, utf-16, utf-32.", errorType: StashErrorTypes.ValueError)
            };
        ...
        ns.Function("fromHex", [Param("hex", "string")], static (IInterpreterContext _, ReadOnlySpan<StashValue> args) =>
        {
            ...
            {
                throw new RuntimeError($"buf.fromHex: invalid hex string '{hex}'.", errorType: StashErrorTypes.ParseError);
            }
        },
            returnType: "byte[]",
        ...
        ns.Function("fromBase64", [Param("b64", "string")], static (IInterpreterContext _, ReadOnlySpan<StashValue> args) =>
        {
            ...
            {
                throw new RuntimeError($"buf.fromBase64: invalid base64 string.", errorType: StashErrorTypes.ParseError);
            }
        },
            returnType: "byte[]",
        ...
        ns.Function("of", [Param("values")], static (IInterpreterContext _, ReadOnlySpan<StashValue> args) =>
        {
            ...
            for (int i = 0; i < args.Length; i++)
            {
                ...
                else if (v.IsInt)
                {
                    long n = v.AsInt;
                    if (n < 0 || n > 255)
                        throw new RuntimeError($"buf.of: argument {i} has value {n} which is out of byte range [0, 255].", errorType: StashErrorTypes.ValueError);
                    data[i] = (byte)n;
                }
                else
                    throw new RuntimeError($"buf.of: argument {i} must be a byte or int (0-255).", errorType: StashErrorTypes.TypeError);
            }
            return StashValue.FromObj(new StashByteArray(data));
        },
            returnType: "byte[]",
        ...
        ns.Function("indexOf", [Param("data", "byte[]"), Param("search"), Param("from", "int")], static (IInterpreterContext _, ReadOnlySpan<StashValue> args) =>
        {
            ...
            if (searchVal.IsByte || searchVal.IsInt)
            {
                ...
                if (rawVal < 0 || rawVal > 255) throw new RuntimeError("buf.indexOf: search byte must be in range [0, 255].", errorType: StashErrorTypes.ValueError);
            ...
            throw new RuntimeError("Second argument to 'buf.indexOf' must be a byte, int (0-255), or byte[].", errorType: StashErrorTypes.TypeError);
        },
            returnType: "int",
            isVariadic: true,
        ...
        ns.Function("includes", [Param("data", "byte[]"), Param("search")], static (IInterpreterContext _, ReadOnlySpan<StashValue> args) =>
        {
            ...
            {
                long rawVal = searchVal.IsByte ? searchVal.AsByte : searchVal.AsInt;
                if (rawVal < 0 || rawVal > 255) throw new RuntimeError("buf.includes: search byte must be in range [0, 255].", errorType: StashErrorTypes.ValueError);
            ...
            throw new RuntimeError("Second argument to 'buf.includes' must be a byte, int (0-255), or byte[].", errorType: StashErrorTypes.TypeError);
        },
            returnType: "bool",
        ...
        ns.Function("copy", [Param("src", "byte[]"), Param("dest", "byte[]"), Param("destOffset", "int"), Param("srcStart", "int"), Param("srcEnd", "int")], static (IInterpreterContext _, ReadOnlySpan<StashValue> args) =>
        {
            ...
            if (srcStart < 0 || srcEnd < 0 || destOffset < 0)
                throw new RuntimeError("buf.copy: offsets must be non-negative.", errorType: StashErrorTypes.ValueError);
            if (srcStart > src.Count || srcEnd > src.Count)
                throw new RuntimeError("buf.copy: source range out of bounds.", errorType: StashErrorTypes.IndexError);
        ...
        ns.Function("writeUint8", [Param("data", "byte[]"), Param("offset", "int"), Param("value", "int")], static (IInterpreterContext _, ReadOnlySpan<StashValue> args) =>
        {
            ...
            if (val < 0 || val > 255) throw new RuntimeError($"buf.writeUint8: value {val} out of range [0, 255].", errorType: StashErrorTypes.ValueError);
        ...
        ns.Function("writeUint16BE", [Param("data", "byte[]"), Param("offset", "int"), Param("value", "int")], static (IInterpreterContext _, ReadOnlySpan<StashValue> args) =>
        {
            ...
            if (val < 0 || val > 65535) throw new RuntimeError($"buf.writeUint16BE: value {val} out of range [0, 65535].", errorType: StashErrorTypes.ValueError);
        ...
        ns.Function("writeUint16LE", [Param("data", "byte[]"), Param("offset", "int"), Param("value", "int")], static (IInterpreterContext _, ReadOnlySpan<StashValue> args) =>
        {
            ...
            if (val < 0 || val > 65535) throw new RuntimeError($"buf.writeUint16LE: value {val} out of range [0, 65535].", errorType: StashErrorTypes.ValueError);
        ...
        ns.Function("writeUint32BE", [Param("data", "byte[]"), Param("offset", "int"), Param("value", "int")], static (IInterpreterContext _, ReadOnlySpan<StashValue> args) =>
        {
            ...
            if (val < 0 || val > 4294967295L) throw new RuntimeError($"buf.writeUint32BE: value {val} out of range [0, 4294967295].", errorType: StashErrorTypes.ValueError);
        ...
        ns.Function("writeUint32LE", [Param("data", "byte[]"), Param("offset", "int"), Param("value", "int")], static (IInterpreterContext _, ReadOnlySpan<StashValue> args) =>
        {
            ...
            if (val < 0 || val > 4294967295L) throw new RuntimeError($"buf.writeUint32LE: value {val} out of range [0, 4294967295].", errorType: StashErrorTypes.ValueError);
        ...
        ns.Function("writeInt8", [Param("data", "byte[]"), Param("offset", "int"), Param("value", "int")], static (IInterpreterContext _, ReadOnlySpan<StashValue> args) =>
        {
            ...
            if (val < -128 || val > 127) throw new RuntimeError($"buf.writeInt8: value {val} out of range [-128, 127].", errorType: StashErrorTypes.ValueError);
        ...
        ns.Function("writeInt16BE", [Param("data", "byte[]"), Param("offset", "int"), Param("value", "int")], static (IInterpreterContext _, ReadOnlySpan<StashValue> args) =>
        {
            ...
            if (val < -32768 || val > 32767) throw new RuntimeError($"buf.writeInt16BE: value {val} out of range [-32768, 32767].", errorType: StashErrorTypes.ValueError);
        ...
        ns.Function("writeInt16LE", [Param("data", "byte[]"), Param("offset", "int"), Param("value", "int")], static (IInterpreterContext _, ReadOnlySpan<StashValue> args) =>
        {
            ...
            if (val < -32768 || val > 32767) throw new RuntimeError($"buf.writeInt16LE: value {val} out of range [-32768, 32767].", errorType: StashErrorTypes.ValueError);
        ...
        ns.Function("writeInt32BE", [Param("data", "byte[]"), Param("offset", "int"), Param("value", "int")], static (IInterpreterContext _, ReadOnlySpan<StashValue> args) =>
        {
            ...
            if (val < -2147483648L || val > 2147483647L) throw new RuntimeError($"buf.writeInt32BE: value {val} out of range [-2147483648, 2147483647].", errorType: StashErrorTypes.ValueError);
        ...
        ns.Function("writeInt32LE", [Param("data", "byte[]"), Param("offset", "int"), Param("value", "int")], static (IInterpreterContext _, ReadOnlySpan<StashValue> args) =>
        {
            ...
            if (val < -2147483648L || val > 2147483647L) throw new RuntimeError($"buf.writeInt32LE: value {val} out of range [-2147483648, 2147483647].", errorType: StashErrorTypes.ValueError);
