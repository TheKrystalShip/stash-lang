...
public static partial class ArchiveBuiltIns
{
    ...
    /// <exception cref="IOError">if an input path does not exist, the output file already exists without overwrite, or a filesystem error occurs</exception>
    /// <exception cref="ValueError">if input paths are empty or options fields have invalid values</exception>
    ...
    /// <exception cref="IOError">if the archive file is not found, an output file already exists without overwrite, or a filesystem error occurs</exception>
    /// <exception cref="ParseError">if the file is not a valid ZIP archive</exception>
    /// <exception cref="ValueError">if an entry would extract outside the target directory or options fields have invalid values</exception>
    ...
    /// <param name="options">Optional ArchiveOptions struct with overwrite, preservePaths, filter (glob pattern)</param>
    /// <exception cref="IOError">if the archive file is not found, an output file already exists without overwrite, or a filesystem error occurs</exception>
    /// <exception cref="ParseError">if the file is not a valid TAR archive</exception>
    /// <exception cref="ValueError">if an entry would extract outside the target directory or too many arguments are provided</exception>
    /// <returns>An array of extracted file paths</returns>
    [StashFn(ReturnType = "array")]
    ...
    /// <exception cref="IOError">if the input file is not found, or a filesystem error occurs during compression</exception>
    /// <exception cref="ValueError">if too many arguments are provided</exception>
    ...
    /// <exception cref="ParseError">if the file is not a valid gzip archive</exception>
    /// <exception cref="IOError">if the input file is not found, or a filesystem error occurs during decompression</exception>
    /// <exception cref="ValueError">if too many arguments are provided</exception>
    ...
    /// <exception cref="IOError">if the archive file is not found or a filesystem error occurs</exception>
    /// <exception cref="ParseError">if the archive data is malformed</exception>
    /// <exception cref="ValueError">if the file extension does not identify a supported archive format</exception>
