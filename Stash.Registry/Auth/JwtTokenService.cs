...
public sealed class JwtTokenService
{
    ...
    /// </exception>
    /// <summary>
    /// Gets a value indicating whether the signing key was auto-generated at startup
    /// (i.e. no key was found in configuration). When <see langword="true"/> tokens will
    /// not survive process restarts.
    /// </summary>
    public bool IsKeyAutoGenerated { get; }
